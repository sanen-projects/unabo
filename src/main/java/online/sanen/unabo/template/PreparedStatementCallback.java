 ...
 * @since 16.03.2004
 * @see SqlTemplate#execute(String, PreparedStatementCallback)
 * @see SqlTemplate#execute(PreparedStatementCreator, PreparedStatementCallback)
 */
public interface PreparedStatementCallback<T> {
	 ...
	 * @see SqlTemplate#queryForObject(String, Object[], Class)
	 * @see SqlTemplate#queryForList(String, Object[])
	 */
